...
export function AllBrandsPage() {
  ...
  const renderContent = () => {
    ...
    if (isError || !brands) {
      return <p className="text-red-500 text-center">Error loading brands.</p>;
    }
    
    if (brands.length === 0) {
      return <p className="text-center">No approved brands found.</p>;
    }
    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex gap-4">
          <Link to="/brands/new" className="text-orange-600 hover:underline">
            New Brands
          </Link>

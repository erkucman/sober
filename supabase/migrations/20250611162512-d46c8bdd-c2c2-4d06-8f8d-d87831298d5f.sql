...
CREATE TABLE public.property_types (
  ...
  description TEXT,
  data_type TEXT NOT NULL DEFAULT 'text', -- text, number, boolean, date, url
...
CREATE TABLE public.user_activities (
  ...
  entity_type TEXT, -- 'product', 'brand', 'review', etc.
  entity_id UUID,
  metadata JSONB, -- Additional data like platform for social shares
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()
);
